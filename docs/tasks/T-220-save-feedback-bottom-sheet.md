...
- Depends on: `T-100-share-target-flow`, `T-110-quick-tile-flow`, `T-120-media-store-batch-query`, `T-130-storage-access-framework-picker`
- Blocked by: `T-130` 미완료
- Ready criteria: Share/Tile/MediaStore/SAF 저장 결과 이벤트가 전달됨
